...
const DryFruitComponent = ({ WishlistCart, AddToCart }) => {
  ...
  useEffect(() => {
    axios
      .get('https://appy.trycatchtech.com/v3/maganlalchikki/product_list?category_id=4')
      .then(response => {
     ...
     <>
      ...
      <div className='w-full relative'>
        ...
        <div className='absolute inset-0 bg-black bg-opacity-65 block text-center '>
          <p className='font-serif text-2xl text-white mt-16'>Dry Fruit Roll</p>
          <p className='text-sm text-white font-sans'><a href="/" className='hover:text-red-600'>Home</a> | <span className='text-red-600'>Dry Fruit Roll</span></p>
        </div>
      </div>
      ...
      <div className="productapi py-10 flex flex-col lg:flex-row lg:items-stretch justify-center items-center gap-4 bg-offwhite">
        <div className='w-72 h-max flex flex-col justify-center'>
          <div className='border-t-2 rounded border-red-500 h-2/5 bg-white'>
            ...
            <ul className='w-full pl-5 py-2 border-b-2 border-red-500'>
              ...
              <li className='text-xs cursor-pointer hover:text-red-500 text-red-500 font-serif p-2'><Link to='/dryfruit'>Dry Fruit Roll</Link></li>
        ...
        <div>
          <h1 className='-mt-1 font-serif font-semibold text-xl border-b border-red-500 pb-2'>Dry Fruit Roll</h1>
...
export default DryFruitComponent
